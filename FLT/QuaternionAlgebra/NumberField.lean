...
theorem GL2.mem_localTameLevel_iff {v : HeightOneSpectrum (𝓞 F)}
  ...
  constructor
  · intro h
    refine ⟨v_le_one_of_mem_localFullLevel v h.1, v_det_val_mem_localFullLevel_eq_one h.1, h.2.1, h.2.2⟩
  · intro ⟨h1, h2, h3, h4⟩
    exact ⟨mem_localFullLevel_iff_v_le_one_and_v_det_eq_one.mpr ⟨h1, h2⟩, h3, h4⟩
